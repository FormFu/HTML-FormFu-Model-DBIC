...
# Basic form.
{
    ...
    $form->load_config_file('t-aggregate/constraints/dbic_unique.yml');
...
# Form where DB column differs from form field name.
{
    ...
    $form->load_config_file('t-aggregate/constraints/dbic_unique_column.yml');
...
# Form tracking a multi-column unique key (name+title).
{
    ...
    $form->load_config_file('t-aggregate/constraints/dbic_unique_others.yml');
...
# Form using a method_name to determine uniqueness with record on stash (is_name_available).
{
    ...
    $form->load_config_file('t-aggregate/constraints/dbic_unique_method.yml');
...
# Form where id_field defined
{
    ...
    $form->load_config_file('t-aggregate/constraints/dbic_unique_id_field.yml');
